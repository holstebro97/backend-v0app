...
const kneeFunctions = ["Flexion", "Extension", "Internal Rotation", "External Rotation"]
...
const generateInitialExercises = (): Exercise[] => {
  ...
  return kneeFunctions.flatMap((func) =>
    ranges.map((range) => ({
      ...
      exercises: [
        {
          name: `${range === "short" ? "Short" : "Full"} Range Knee ${func} Exercise 1`,
          description: `Strengthen your knee muscles with ${range === "short" ? "limited" : "full"} range of motion`,
          function: func,
          range: range,
          youtubeLink: "https://www.youtube.com/watch?v=example",
          youtubeTitle: `${range === "short" ? "Short" : "Full"} Range Knee ${func} Exercise 1`,
          typeOfMovement: "Compound Exercise",
        },
        {
          name: `${range === "short" ? "Short" : "Full"} Range Knee ${func} Exercise 2`,
          description: `Isolate your knee muscles with ${range === "short" ? "limited" : "full"} range of motion`,
          function: func,
          range: range,
          youtubeLink: "https://www.youtube.com/watch?v=example",
          youtubeTitle: `${range === "short" ? "Short" : "Full"} Range Knee ${func} Exercise 2`,
